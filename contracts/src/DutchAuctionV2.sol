...
/// @dev Minimal ERC-777 send interface ($WARPGOBB is an ERC-777 SuperToken).
interface IERC777Send {
    function send(address recipient, uint256 amount, bytes calldata data) external;
}

/// @title DutchAuctionV2 — "The Gobbler"
...
/// @dev This contract is a fork of DutchAuction, but with a hook for the arb contract to call without needing funds.

contract DutchAuctionV2 is IDutchAuction, IERC721Receiver {
